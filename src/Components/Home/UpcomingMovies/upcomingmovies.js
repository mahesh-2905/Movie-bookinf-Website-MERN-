...
import UPMHeader from './upmovie_header';
import '../movietypecommon.css';
import { Link } from 'react-router-dom';

const HomeUpcomingMovies = (props)=>{
   

  
  

  const renderUpcomingCarousel = ({Images})=>{
                      ...
                      <div className="card moviecard ">
                        <div className="img">
                          ...
                          <div className="card-body p-0 pt-2">
                            <p className="card-title text-center">{data.name}</p>
                          </div>
